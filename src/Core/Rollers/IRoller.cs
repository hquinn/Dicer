...
public interface IRoller
{
	...
	/// <param name="keep">How many dice to keep from highest to lowest. If value is null, then <paramref name="numDice"/> will be used. If a negative number is specified, then the dice will be kept from lowest to highest.</param>
